 ...
 * Created by 23.02.19 20:40
 */
public class WhereActiveQuery<T extends IQueryBuilder.Select> extends ActiveQuery<T> {

    private final WhereFunc.Where mFunc;

    public WhereActiveQuery(final ActiveQuery<T> activeQuery, final WhereFunc.Where func) {
        super(activeQuery);
        mFunc = func;
    }
